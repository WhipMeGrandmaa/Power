...
public final class PowerShopCauldronFile extends YamlConfig {

	@Getter
	private static PowerShopCauldronFile instance;

	public static List<Location> powerShopCauldronManager = new ArrayList<>();

	private boolean remove;

	private PowerShopCauldronFile() {
	...
	public static void onEnable() {
		instance = new PowerShopCauldronFile();
	}
}
